...
class User(Base):
    ...
    name: Mapped[str] = mapped_column(String(255), nullable=True)  # For OAuth users
    ...
    oauth_provider: Mapped[str] = mapped_column(String(50), nullable=True)  # 'google', 'email', etc.
